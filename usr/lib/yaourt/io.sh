...
parse_color_var() {
	...
	vars="BOLD BLINK RED GREEN YELLOW BLUE PURPLE CYAN"
	colors=(${1//:/ })
...
init_color() {
	...
	C0="\033[0m" 
	# yaourt colors 
	local yaourt_colors="BOLD=0:BLINK=5:RED=1;31:GREEN=32:YELLOW=33:BLUE=34:PURPLE=35:CYAN=36"
	# package-query colors (packages listing)
	local pq_colors="no=0:other=35:testing=31:core=31:extra=32:local=33:nb=7;33:pkg=1:installed=33;7:votes=33:od=33;7"
	# env COLORS
